export default function TripPrivacy() {
    return (
        <details className="border border-[var(--border)] bg-[var(--surface)] p-5 text-sm leading-6">
            ...
            <div className="mt-3 space-y-3 text-[var(--text-muted)]">
                <p>
                    Tracking starts only when you press Start tracking and allow browser location access. Only current
                    trip participants can see your location. Stop tracking removes your map marker; Leave trip deletes
                    your GPS records immediately and removes your public entry.
                </p>
                <p>
                    ...
                    trip or account is deleted. Public leaderboards show only opted-in account names, initial avatars,
                    progress, and checkpoint totals—never GPS locations or last-seen times.
                </p>
                <p>
