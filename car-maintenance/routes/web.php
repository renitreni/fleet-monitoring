...
Route::middleware(['auth', PrivateTripResponse::class])->group(function () {
    ...
    Route::get('/admin/map-settings', [AdminMapDesignController::class, 'show'])->name('admin.map-settings.show');
    Route::put('/admin/map-settings', [AdminMapDesignController::class, 'update'])->name('admin.map-settings.update');
